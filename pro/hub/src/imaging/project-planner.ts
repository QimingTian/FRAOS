import type { FilterPlan, FilterRemaining } from '../db.js'
import { DSO_SESSION_OVERHEAD_SEC } from './session-overhead.js'
...
import {
  ...
  type TimeInterval,
} from '../astro/tonight-weather-gate.js'
import { moonFilterSessionOk } from '../astro/moon-avoidance.js'
