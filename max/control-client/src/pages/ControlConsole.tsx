...
import { ACTIVE_MAX_SITE_CHANGED } from '../lib/active-max-site'
...
export function ControlConsole({
  ...
  useEffect(() => {
    ...
    window.addEventListener(ACTIVE_MAX_SITE_CHANGED, onSiteChange)
    return () => {
      window.clearInterval(statusId)
      window.clearInterval(hubId)
      window.clearInterval(weatherId)
      document.removeEventListener('visibilitychange', onVisibility)
      window.removeEventListener(ACTIVE_MAX_SITE_CHANGED, onSiteChange)
    }
